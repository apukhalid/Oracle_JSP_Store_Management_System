...
int qstore=qok+qnotok+qrun;

try{
Connection conn = null;
Class.forName("sun.jdbc.odbc.JdbcOdbcDriver").newInstance();
conn = DriverManager.getConnection("jdbc:odbc:orcl","system", "khalid1");
Statement st=null;
st=conn.createStatement();
st.executeUpdate("update store set qstore='"+qstore+"',qok='"+qok+"',qnotok='"+qnotok+"',qrun='"+qrun+"' where name='"+name+"'");
}
catch(Exception e){
...
<h1> Information Successfully Edited </h1>	
