...
<%
int qstore=Integer.parseInt(request.getParameter("qstore"));
int qok=Integer.parseInt(request.getParameter("qok"));
int qnotok=Integer.parseInt(request.getParameter("qnotok"));
int qrun=Integer.parseInt(request.getParameter("qrun"));
String name=request.getParameter("name");



Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
           Connection con = DriverManager.getConnection("jdbc:odbc:orcl","system","khalid1");
           Statement st=con.createStatement();
           int i=st.executeUpdate("insert into store(qstore,qok,qnotok,qrun,name) values('"+qstore+"','"+qok+"','"+qnotok+"','"+qrun+"','"+name+"')");
