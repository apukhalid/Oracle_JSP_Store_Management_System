...
%>			
				 <h1> Please Edit Your Item Information : </h1><br>
				<form action="editpro2.jsp" method="post">
                     <center>               
                 Iteam Name  : <input type="text" name="name" value="<% out.println(edit); %>"><br><br>
                    Stock(OK): <input type="text" name="qok"> <br><br>
	        Stock(Not OK): <input type="text" name="qnotok"> <br><br>
	        Iteam Running: <input type="text" name="qrun"> <br><br>
